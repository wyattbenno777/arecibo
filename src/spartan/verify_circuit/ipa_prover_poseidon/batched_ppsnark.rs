...
pub struct BatchedRelaxedR1CSSNARK<E: Engine> {
  ...
  pub(crate) comms_L_row_col: Vec<[CompressedCommitment<E>; 2]>,
  // commitments to aid the memory checks
  // [t_plus_r_inv_row, w_plus_r_inv_row, t_plus_r_inv_col, w_plus_r_inv_col]
  pub(crate) comms_mem_oracles: Vec<[CompressedCommitment<E>; 4]>,

  // claims about Az, Bz, and Cz polynomials
  pub(crate) evals_Az_Bz_Cz_at_tau: Vec<[E::Scalar; 3]>,

  // sum-check
  pub(crate) sc: SumcheckProof<E>,

  // claims from the end of sum-check
  pub(crate) evals_Az_Bz_Cz_W_E: Vec<[E::Scalar; 5]>,
  pub(crate) evals_L_row_col: Vec<[E::Scalar; 2]>,
  // [t_plus_r_inv_row, w_plus_r_inv_row, t_plus_r_inv_col, w_plus_r_inv_col]
